          ...
          {navigationItems.map(item => {
            ...
            return (
              ...
              >
                ...
                {!isCollapsed && (
                  <span className='ml-sm font-medium'>{item.label}</span>
                )}
              </a>
            );
          })}
    ...
    <div className='bg-primary-card p-md rounded-lg border border-white/10 shadow-md'>
      <div className='flex justify-between items-start'>
        <div className='space-y-xs'>
          <p className='text-xs uppercase font-semibold tracking-wider text-text-secondary'>
            {title}
          </p>
            ...
            >
              <div className='grid grid-cols-1 md:grid-cols-12 gap-sm items-center'>
                ...
                <div className='md:col-span-3 flex justify-end items-center space-x-sm'>
                  <button className='text-xs bg-primary-surface border border-white/10 px-sm py-xs rounded-md hover:bg-white/10'>
                    View Details
                  </button>
                </div>
              </div>
          ...
          <div className='space-y-sm'>
            ...
            <div>
              ...
              <div className='flex items-center space-x-sm mt-1'>
                ...
                <span className='font-bold text-primary-accent w-8 text-right text-sm'>
                  {aggressiveness}%
                </span>
              </div>
            </div>
  ...
  return (
    <div className='min-h-screen'>
      ...
      >
        ...
        <main className='p-md'>{currentPage.component}</main>
      </div>
    </div>
  );
};

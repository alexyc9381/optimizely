...
export const ThemeExample: React.FC<ThemeExampleProps> = ({ onThemeChange }) => {
  const [currentTheme, setCurrentTheme] = useState<Theme>(themeEngine.getCurrentTheme());
  const [activeTab, setActiveTab] = useState<'customizer' | 'preview' | 'examples'>('preview');
  ...
  const [previewChartType, setPreviewChartType] = useState<'line' | 'bar' | 'doughnut' | 'scatter'>('line');
  ...
  const applyThemeToDocument = useCallback((theme: Theme) => {
    ...
    root.style.setProperty('--theme-secondary', theme.colorPalette.secondary[0]);
    root.style.setProperty('--theme-success', theme.colorPalette.semantic.success[0]);
    root.style.setProperty('--theme-warning', theme.colorPalette.semantic.warning[0]);
    root.style.setProperty('--theme-error', theme.colorPalette.semantic.error[0]);
    root.style.setProperty('--theme-info', theme.colorPalette.semantic.info[0]);

    // Apply typography
    root.style.setProperty('--theme-font-primary', theme.typography.fontFamily.primary);
    root.style.setProperty('--theme-font-secondary', theme.typography.fontFamily.secondary);
    root.style.setProperty('--theme-font-mono', theme.typography.fontFamily.monospace);
    ...
    <div className="theme-example">
      ...
      <div className="theme-example-header">
        <div className="header-content">
          ...
          <p>Comprehensive theming and customization capabilities with live preview</p>
        </div>
              ...
              <div className="preview-chart">
                <UniversalChart
                  ...
                  options={{
                    ...
                    scales: previewChartType !== 'doughnut' ? {
                      x: {
                        ticks: {
                ...
                <div className="theme-info-card">
                  ...
                  <div className="theme-details">
                    ...
                    <div className="detail-item">
                      ...
                      <span className={`category-badge ${currentTheme.category}`}>
                  ...
                  <div className="palette-colors">
                    <div className="color-group">
                      ...
                      <div className="color-swatches">
                        {currentTheme.colorPalette.primary.map((color, index) => (
                          <div
                            key={index}
                    ...
                    <div className="color-group">
                      ...
                      <div className="color-swatches">
                        {currentTheme.colorPalette.secondary.map((color, index) => (
                          <div
                            key={index}
                            className="color-swatch"
                            style={{ backgroundColor: color }}
          ...
          <div className="examples-section">
            ...
            <div className="examples-grid">
              ...
              <div className="example-card">
                ...
                <div className="example-description">
                  Ideal for comparing categorical data with clear visual distinction.
                </div>
              </div>
              ...
              <div className="example-card">
                ...
                <div className="example-description">
                  Great for showing proportional data and part-to-whole relationships.
                </div>
              </div>
